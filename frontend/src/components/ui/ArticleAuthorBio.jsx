...
export default function ArticleAuthorBio({
    ...
    return (
        ...
        <div className="mt-8 p-6 rounded-lg shadow-md bg-base-200">
            <div className="flex items-start gap-4">
                <div className="avatar shrink-0">
                    <div className="w-20 rounded-full ring ring-blue-500 ring-offset-2 ring-offset-gray-50 dark:ring-offset-gray-800">
                        <Image src={avatarUrl} alt={`${name}'s avatar`} width={80} height={80} loading="lazy" unoptimized />
                    </div>
                </div>
                <div className="flex-1 min-w-0">
                    {/* Dark mode: dark:text-white */}
                    <h3 className="text-xl font-bold text-base-content mb-2">{name}</h3>
